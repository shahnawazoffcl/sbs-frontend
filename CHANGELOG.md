...
- Create Angular project with ng: `ng new satnambikeservice.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`satnambikeservice.client.esproj`).
